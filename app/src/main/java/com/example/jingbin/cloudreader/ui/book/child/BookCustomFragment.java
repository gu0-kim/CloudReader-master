...
public class BookCustomFragment extends BaseFragment<FragmentBookCustomBinding> {
    ...
    private void loadCustomData() {
        ...
        Subscription get = HttpUtils.getInstance().getDouBanServer().getBook(mType, mStart, mCount).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<BookBean>() {
            @Override
